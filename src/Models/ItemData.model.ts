...
const contact2: Contact = new Contact(
  'fella guy',
  666666666,
  'fellaoftheguy@gmail.com'
);
const contact3: Contact = new Contact(
  'Tomer Shevach',
  77777777,
  'thetomerheuheu11@gmail.com'
);
const contact4: Contact = new Contact(
  'Israel Israeli',
  888888888,
  '123iloveisrael123@gmail.com'
);
